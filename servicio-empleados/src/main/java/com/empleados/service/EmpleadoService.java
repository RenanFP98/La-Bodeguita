...
public class EmpleadoService {
    ...
    public List<Empleado> buscarPorNombre(String nombre) {
        return empleadoRepository.findByNomUsuaContainingIgnoreCase(nombre);
    }

    public List<Empleado> buscarPorEstado(Boolean estado) {
        return empleadoRepository.findByEstadoUsua(estado);
    }

    public List<Empleado> listarAscendente() {
        return empleadoRepository.findAllByOrderByNomUsuaAsc();
    }

    public List<Empleado> listarDescendente() {
        return empleadoRepository.findAllByOrderByNomUsuaDesc();
    }
}
